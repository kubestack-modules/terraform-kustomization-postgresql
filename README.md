...
This module installs Postgresql on Kubernetes.
...
The module bundles an upstream release of Postgresql and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_$module_name" {
  ...
  source  = "kubestack-modules/postgresql/kustomization"
